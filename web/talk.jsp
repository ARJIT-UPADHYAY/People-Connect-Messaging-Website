									...
									<div class="row">
										...
										<div class="form-group">
											<%
                                                                                        ...
                                                                                        %>
                                                                                        <div class="col-lg-2">
                                                                                            <label class for="message" class="control-label">File: <a href="DownloadFile.jsp?pid=<%=message.get("pid")%>" ><%= message.get("filename")%></a></label>
											</div>
                                                                                        <%    
                                                                                        }
                                                                                        %>
											<div class="col-lg-2">
												<label class for="message" class="control-label">Date: <%= message.get("udate")%></label>
											</div>
										</div>
										</font>
									</div>
	...
	<div class="navbar navbar-inverse navbar-fixed-bottom">
		<div class="container">
			<div class="navbar-text pull-left">
				<p>Designed and developed by SUKRITI  and  ARJIT</p>
			</div>
		</div>
	</div>
